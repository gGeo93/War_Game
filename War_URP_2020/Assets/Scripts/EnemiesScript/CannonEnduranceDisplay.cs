public class CannonEnduranceDisplay : EnduranceFunctionality, IDamageable
{
    ...
    {
        GameManager.Instance.AudioManager.SoundToPlay(GameManager.Instance.AudioManager.towerCannonDestroyedSound);
    }
}
